// Local subscriptions and feed cache for YouTube Local Feed.
//
...
(function () {
    ...
    async function getFeedSettings() {
        ...
        cachedSettings = {
            ...
            hideYouTubeRecommendations: s.hideYouTubeRecommendations === true,
    ...
    function injectStyles() {
        ...
        style.textContent = `
            ...
            /* Optional distraction-free YouTube mode. Keep this narrowly
               scoped to Home recommendations and watch-page related videos. */
            html[ytvht-hide-youtube-recommendations] ytd-browse[page-subtype="home"] ytd-rich-grid-renderer,
            html[ytvht-hide-youtube-recommendations] ytd-browse[page-subtype="home"] #contents.ytd-rich-grid-renderer,
            html[ytvht-hide-youtube-recommendations] ytd-watch-flexy #related,
            html[ytvht-hide-youtube-recommendations] ytd-watch-flexy ytd-watch-next-secondary-results-renderer {
                display: none !important;
            }
    ...
    function applyGlobalUiPreferences(settings) {
        ...
        // This setting intentionally affects only YouTube Home recommendations
        // and watch-page Up next / related videos. Search, Subscriptions,
        // channel pages and playlists remain untouched.
        de.toggleAttribute(
            'ytvht-hide-youtube-recommendations',
